...
//  <iframe style="border: 0; width: 350px; height: 442px;" src="https://bandcamp.com/EmbeddedPlayer/track=682966733/size=large/bgcol=ffffff/linkcol=0687f5/tracklist=false/transparent=true/" seamless><a href="http://graysonerhard.bandcamp.com/track/karma">Karma by Grayson Erhard</a></iframe>
  ...
  if ($bandcampID) {
    ...
    <div class="bwpp_iframe_wrap">
      <iframe style="border: 0; width: 100%; height: 100vh;" src="https://bandcamp.com/EmbeddedPlayer/track=<?php echo $bandcampID; ?>/size=large/bgcol=ffffff/linkcol=0687f5/tracklist=false/transparent=true/" seamless><?php echo the_title(); ?></iframe>
    </div>
    <?php
